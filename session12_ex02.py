    ...
    if choice == '1' :
        ...
        for acc in saving_accounts:
            if check_id == acc['account_id']:
                ...
                print(f"--- Tìm thấy mã sổ: {check_id} ---")
                
                while True:
                    temp_name = input("Nhập tên khách hàng mới: ").strip()
                    if temp_name != "":
                        break
                ...
                while True:
                    try:
                        temp_price = int(input("Nhập số tiền gửi mới: "))
                        if temp_price > 0:
                            break
                ...
                while True:
                    try:
                        temp_term = int(input("Nhập kỳ hạn mới theo tháng: "))
                        if temp_term > 0:
                            break
                ...
                while True:
                    try:
                        temp_rate = float(input("Nhập lãi suất năm mới: "))
                        if temp_rate > 0:
                            break
                ...
                acc['customer_name'] = temp_name
                acc['balance'] = temp_price
                acc['term_months'] = temp_term
                acc['interest_rate'] = temp_rate
